...
let instructions = {
  ...
  stimulus: (
    `<div style="max-width: ${spacing_answers*2}px; margin: auto; font-size: ${instructions_font_size}px; line-height: 1.5;">
      ...
      <p>
        ${study_phase_repeats === 1 
          ? `Note that you will see each image only <b>once</b> during the study phase. 
          So, please pay close attention and try to remember each image carefully.` 
  ...
  stimulus: (
    `<div style="max-width: ${spacing_answers*2}px; margin: auto; font-size: ${instructions_font_size}px; line-height: 1.5;">
      ...
      <p>
        ...
        You will receive 1 credit soon; please allow some time for processing. 
        If you do not receive a confirmation email within <b>one week</b>, please contact the experimenter. 
        <b>Important</b>: Please do not run the experiment again.
      </p>
      <p>
        In this study, we are investigating what makes certain objects more memorable than others.  
