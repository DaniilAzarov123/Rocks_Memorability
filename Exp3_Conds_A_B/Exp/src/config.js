...
const condition = Math.random() < 0.5 ? "1_Rep" : "3_Rep"; // 1 or 3 repetitions of the study phase
const study_phase_repeats = condition === "1_Rep" ? 1 : 3; // How many times to repeat the study phase (1 = once, 2 = twice, etc.)
